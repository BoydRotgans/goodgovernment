...
import static jujutsu.utils.MatrixOps.addRowVector;
import static jujutsu.utils.MatrixOps.assignAllLessThan;
import static jujutsu.utils.MatrixOps.assignAtIndex;
import static jujutsu.utils.MatrixOps.assignValuesToRow;
import static jujutsu.utils.MatrixOps.biggerThan;
import static jujutsu.utils.MatrixOps.concatenate;
import static jujutsu.utils.MatrixOps.diag;
import static jujutsu.utils.MatrixOps.equal;
import static jujutsu.utils.MatrixOps.exp;
import static jujutsu.utils.MatrixOps.fillMatrix;
import static jujutsu.utils.MatrixOps.getValuesFromRow;
import static jujutsu.utils.MatrixOps.log;
import static jujutsu.utils.MatrixOps.maximum;
import static jujutsu.utils.MatrixOps.mean;
import static jujutsu.utils.MatrixOps.negate;
import static jujutsu.utils.MatrixOps.plus;
import static jujutsu.utils.MatrixOps.range;
import static jujutsu.utils.MatrixOps.replaceNaN;
import static jujutsu.utils.MatrixOps.rnorm;
import static jujutsu.utils.MatrixOps.scalarDivide;
import static jujutsu.utils.MatrixOps.scalarInverse;
import static jujutsu.utils.MatrixOps.scalarMult;
import static jujutsu.utils.MatrixOps.scalarPlus;
...
import static jujutsu.utils.MatrixOps.tile;
	...
	public double [][] tsne(TSneConfiguration config) {
		...
		for (int iter = 0; iter < max_iter && !abort; iter++) {
			...
			if ((iter % 100 == 0))   {
				...
				System.out.println("a Iteration " + (iter + 1) + ": error is " + C);
			} else if((iter + 1) % 10 == 0) {
				System.out.println("a Iteration " + (iter + 1));
			}

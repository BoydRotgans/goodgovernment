...
public class ParallelSPTree extends jujutsu.tsne.barneshut.SPTree {
...
//	}
	...
	public ParallelSPTree(jujutsu.tsne.barneshut.SPTree inp_parent, int D, double[] inp_data, double[] inp_corner, double[] inp_width) {
		super(inp_parent, D, inp_data, inp_corner, inp_width);
	}

	public ParallelSPTree(jujutsu.tsne.barneshut.SPTree inp_parent, int D, double[] inp_data, int N, double[] inp_corner, double[] inp_width) {
		super(inp_parent, D, inp_data, N, inp_corner, inp_width);
	}

	@Override
	jujutsu.tsne.barneshut.SPTree[] getTreeArray(int no_children) {
		return new ParallelSPTree[no_children];
	}

	@Override
    jujutsu.tsne.barneshut.SPTree getNewTree(SPTree root, double[] new_corner, double[] new_width) {

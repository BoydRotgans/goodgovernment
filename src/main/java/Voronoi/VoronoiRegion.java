...
public class VoronoiRegion {
    ...
    public List<VoronoiPoint> pointsEmpty = new ArrayList<>();
    //public Path path;
    ...
    private void initPoints() {
        ...
        if(points.size() > 3 ) {
            ...
            for(int i = 0; i<10; i++) {
                pointsEmpty.add(new VoronoiPoint(Math.random()*10.0, Math.random()*10.0));
            }
...
//        path.close();
    ...
    private void prepareCenter() {
        ...
        center_rect = new VoronoiPoint(0.0, 0.0);
    }
